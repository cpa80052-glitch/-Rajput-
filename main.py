...
API_ID    = os.environ.get("API_ID", "28389286")
API_HASH  = os.environ.get("API_HASH", "b88da5f4f338cca30f8ea5fb53cb083b")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8774729055:AAFFK30VCT1bg_gHG-Q98h1K3PndR1BBuNQ") 

# Get the MongoDB collection for this bot
collection = get_collection(BOT_NAME, MONGO_URI)
# Constants
OWNER_IDS = [7549194607]  # Replace with the actual owner user IDs

cookies_file_path = "cookies.txt"
# Global variables
log_channel_id = -1002316700577
authorized_users = [7549194607,6334323103]
ALLOWED_CHANNEL_IDS = []
my_name = " 🌸🌿Rajput🌸🌿"
overlay = None 
accept_logs = 0
...
Feel free to contact @praxharaj for further assistance or subscription details.
...
12. **/me** - 💡 Type this before sending your **📃.txt** file.
...
BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton(text="Send Here", url=f"https://t.me/leavingproperty")]])
